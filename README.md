# Vaadin, jOOQ, Fly.io, and Neon

This project can be used as a starting point to create your own Vaadin application with Spring Boot that runs on Fly.io
and uses a database on Neon.

It contains all the necessary configuration and some placeholder files to get you started.

## Deploy to Fly.io

```.github/workflows/ci.yml``` shows how to use GitHub actions to deploy to Fly.io.

## Local development

To run the application locally start a local PostgreSQL database (for example with Docker see
scripts/start_postgres_cmd).
